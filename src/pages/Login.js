  ...
  return (
      <div className='   flex  flex-col items-center bg-slate-200  h-screen justify-center'>
          ...
          <div className=' flex justify-center items-center mb-5 w-36  h-36 rounded-full'>
              ...
              <button type="button" onClick={handleSubmit}  className=' bg-blue-600 w-20 py-1 rounded-md hover:opacity-80 '>Login</button> 
                  <button type="button">
                      Forgot Password ? <span onClick={()=>navigate('/signup')} className=' font-extrabold hover:opacity-80 hover:underline'>Sign Up</span>
                  </button>
              </div>
